...
export async function generateMetadata({ params }: { params: { category: string } }): Promise<Metadata> {
    ...
    if (posts.length === 0) {
        return {
            title: 'Categoría no encontrada - BloGame',
            description: 'La categoría que buscas no existe o no tiene contenido disponible.',
        };
    }
    ...
    return {
        title: `${categoryName} - BloGame`,
        description: `Descubre ${articleCount} ${articlesText} sobre ${categoryName}. Explora contenido de calidad sobre esta temática.`,
        openGraph: {
            title: `${categoryName} - BloGame`,
            description: `${articleCount} ${articlesText} sobre ${categoryName}`,
            type: 'website',
        },
        robots: {
            index: true,
                ...
                <div className="mt-16 text-center">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
                            Explora otras categorías o regresa al inicio para descubrir más contenido interesante.
                        </p>
